 ...
 */
/**
 * This is a helper class to manipulate the database table user_info, as required by
 * the IPL correspondence project
 */
public class UserInfoManager 
{
	...
	public static final String PKG = "IPLCORRES";
	/**
	 * logger for this class
	 */
	public static final TBitsLogger LOG = TBitsLogger.getLogger(PKG);
	...
	public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME +
											  ...
											  " PRIMARY KEY (" + USER_ID + "), " +
											  FIRM + " NVARCHAR(255) NOT NULL, " + 
											  LOCATION + " NVARCHAR(255) NULL, " +										
											  DESIGNATION + " NVARCHAR(255) NULL, " +
											  ADDRESS + " NVARCHAR(255) NULL, " +
											  SEX + " VARCHAR(1) NULL, " +
											  FULL_FIRM_NAME + " NVARCHAR(1000) NULL "+
										     " ) " ;
	...
	/**
	 * gives the complete mapping of userLogin:location 
	 * @return
	...
	public static Hashtable<String,Hashtable<String,String>> lookupUserInfoWithFirm(String firm) throws TBitsException
	{
		...
		try
		{
			...
			while( rs.next() ) 
			{
				...
				if(null == ufirm)
					ufirm = "" ;
				String ulocation = rs.getString(LOCATION) ;
				if( null == ulocation )
					ulocation = "" ;
				...
				if( null == uffn )
					uffn = "" ;
				info.put(FIRM, ufirm ) ;
				info.put(LOCATION, ulocation) ;
				info.put(DESIGNATION, udesignation ) ;
				info.put(ADDRESS, uaddress ) ;
				info.put(SEX, usex ) ;
