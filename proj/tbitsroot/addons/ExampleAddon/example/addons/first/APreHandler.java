 ...
 *
 */
public class APreHandler implements IEventHandler<AddPreEvent> {
	...
	public String getDescription() {
		return "Registered for AddPreEvent";
	}
	 ...
	 */
	@Override
	public void handle(AddPreEvent event) throws EventFailureException {
