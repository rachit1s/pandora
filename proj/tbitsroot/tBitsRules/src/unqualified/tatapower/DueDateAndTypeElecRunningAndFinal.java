...
import tatapower.TataPowerUtils;
 ...
 *
 */
public class DueDateAndTypeElecRunningAndFinal implements IRule {
	...
	public RuleResult execute(Connection connection, BusinessArea ba,
		...
		if (isApplicable && (isPermissibleReqType) && 
				categoryName.equals(TataPowerUtils.ELECTRICAL)){
			...
			try {					
				...
				if (dccDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.SIXTY_PERCENT_DCC_OFFSET);				
				...
				if (udsiDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.SIXTY_PERCENT_SI_OFFSET);
				...
				if(qsDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.SIXTY_PERCENT_QS_OFFSET);
				...
				if(ghDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.SIXTY_PERCENT_GH_OFFSET);
				...
				if(hocDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.SIXTY_PERCENT_HOC_OFFSET);
				...
				if(financeDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.SIXTY_PERCENT_FINANCE_OFFSET);
	...
	public String getName() {
		return this.getClass().getSimpleName() + " - Sets the due date for types Electrical running and Electrical Final";
	}
