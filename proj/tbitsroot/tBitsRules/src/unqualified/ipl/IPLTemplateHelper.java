 ...
 * 
 */
public class IPLTemplateHelper {
	...
	private String loggerImagePath;
	private String yourDtnRef, transmittalDate;
	public IPLTemplateHelper(String toAddress, String dtnNumber, String subject,
			...
			String[] loggerInfo, String reference, 
			String yourDTNRef, String transmittalDate) {
		super();
	...
	public void setDtnRefString(String yourDtnRef) {
		this.yourDtnRef = yourDtnRef;
	}
