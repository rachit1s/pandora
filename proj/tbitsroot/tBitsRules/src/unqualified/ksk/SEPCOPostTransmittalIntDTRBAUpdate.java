 ...
 *
 */
public class SEPCOPostTransmittalIntDTRBAUpdate implements ITransmittalRule {

	/* (non-Javadoc)
	 * @see ksk.ITransmittalRule#getName()
	 */
	public String getName() {
		return this.getClass().getSimpleName() + ": Updates the IntDTR business area post SEPCO transmittal.";
	}
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if (KSKUtils.isSEPCODCR(dcrBA) &&  currentBA.getSystemPrefix().equals("IntDTR")){
			...
			paramTable.put(Field.ASSIGNEE, "WPCL-PHO,WPCL-CEC,WPCL-DCPL");
