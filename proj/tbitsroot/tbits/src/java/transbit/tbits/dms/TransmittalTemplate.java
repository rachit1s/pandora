 ...
 *
 */
public class TransmittalTemplate {
	...
	public TransmittalTemplate(int systemId, int templateId, String templateName, String fileName){
		mySystemId = systemId;
	...
	public TransmittalTemplate(int systemId, int templateId, String templateName, String fileName, String toList, String ccList){
		mySystemId = systemId;
		myTemplateId = templateId;
		myTemplateName = templateName;
		myFileName = fileName;
	...
	public static ArrayList<?> lookupBySystemId(int aSystemId) throws DatabaseException {
		TransmittalTemplate transTemplate = null;
		ArrayList<TransmittalTemplate> transTemplateList = new ArrayList<TransmittalTemplate>();
	...
	public static TransmittalTemplate lookupBySystemIdAndTemplateName(int aSystemId, String aTemplateName) throws DatabaseException {		
		TransmittalTemplate transTemplate = null;
		Connection connection = null;
	...
	public static void insert (TransmittalTemplate tt) throws DatabaseException {		
		Connection connection = null;
		try {
			connection = DataSourcePool.getConnection();
	...
	public static void updateTransmittalTemplate(TransmittalTemplate tt) throws DatabaseException {
		Connection connection = null;
		try {
			connection = DataSourcePool.getConnection();
...
//			connection.close();			
	...
	public static JSONArray getTemplatesJSONArrayForSysId (int aSystemId) throws DatabaseException{
		...
		for (Object obj: ttList){
			TransmittalTemplate tt = (TransmittalTemplate)obj;
	...
	private static TransmittalTemplate createFromResultSet(ResultSet rs) throws SQLException {
		TransmittalTemplate transTemplate = null;
		transTemplate = new TransmittalTemplate (rs.getInt("sys_id"), rs.getInt("template_id"), 
				((rs.getString("template_name") != null) ? rs.getString("template_name") : ""),
				((rs.getString("template_file_name") != null) ? rs.getString("template_file_name") : ""), 
				((rs.getBytes("to_list") != null)	? rs.getString("to_list") : ""), 
				((rs.getString("cc_list") != null) ? rs.getString("cc_list") : ""));
		return transTemplate;
	}
