package com.tbitsGlobal.jaguar.server.utils;
...
public class EscalationServerUtils {
	...
	static class Node{
	  ...
	  public static int checkCycleInEscalationHierarchy(List<EscalationHierarchyValuesClient> hierarchyValues)
	  {
		...
		//L <- Empty list that will contain the sorted elements
		  ...
		  for(EscalationHierarchyValuesClient values:hierarchyValues)
		  {
