...
( 
        ...
        subject,                description,            description_content_type,
		is_private,				parent_request_id,      user_id,                
		max_action_id,			due_datetime,           logged_datetime,        
		lastupdated_datetime,	header_description,     attachments,			
		summary,				summary_content_type,		memo,                   append_interface,       
		notify,					notify_loggers, replied_to_action,office_id 
) 
VALUES 
( 
        @systemId,              @requestId,             @categoryId, 
        @statusId,              @severityId,            @requestTypeId, 
        @subject,               @description,           @descriptionContentType,
		@IsPrivate,				@parentId,              @userId,
        @maxActionId,			@dueDate,               @loggedDate,            
		@updatedDate,			@headerDesc,            @attachments,			
		@summary,				@summaryContentType,	@memo,                  @append,                
		@notify,				@notifyLoggers,         @repliedToAction,          
		@officeId 
)
...
( 
        ...
        @headerDesc,            null,					@summary,			@summaryContentType,
        @memo,                  @append,                @notify, 
