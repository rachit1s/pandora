...
public class ClonePrefillProxyServlet implements IProxyServlet 
{
	public static String servletName = "prefillCloneFromCORR" ;
...
//			String subject = req.get(CorresConstants.CORR_SUBJECT_FIELD_NAME) ;
			...
			prefillTable.put(CorresConstants.CORR_DESCRIPTION_FIELD_NAME, req.get(CorresConstants.CORR_DESCRIPTION_FIELD_NAME));
			prefillTable.put(Field.PARENT_REQUEST_ID, req.getRequestId() + "");
			prefillTable.put("GenerateCorrespondance", "ActionOnly");
