 ...
 *
 */
public class HolcimPlugin implements EntryPoint, IWizardPlugin {
	...
	//	Window.alert("hello");
		((ServiceDefTarget)HolcimConstants.dbService).setServiceEntryPoint("/jaguar/proxy");
