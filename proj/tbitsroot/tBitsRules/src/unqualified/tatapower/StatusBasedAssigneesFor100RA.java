 ...
 *
 */
public class StatusBasedAssigneesFor100RA implements IRule {
		...
		if (isApplicable && (requestType.getName().equals(TataPowerUtils.TYPE_RA100))){
			...
			try {
				if (curStatus.equals(TataPowerUtils.STATUS_DCC)){
					ruList = TataPowerUtils.getRUList(aSystemId, aRequestId, TataPowerUtils.TYPE_RA1OO_DCC_ASSIGNEES);				
				}
				else if (curStatus.equals(TataPowerUtils.STATUS_UDSI)){
					String assigneeList = TataPowerUtils.getProperty(TataPowerUtils.TYPE_RA1OO_SI_ASSIGNEES);
					if ((assigneeList== null) || assigneeList.trim().equals("")){
						...
						ruList = TataPowerUtils.getRUList(aSystemId, aRequestId, TataPowerUtils.TYPE_RA1OO_SI_ASSIGNEES);
				}
				else if (curStatus.equals(TataPowerUtils.STATUS_QS)){
					ruList = TataPowerUtils.getRUList(aSystemId, aRequestId, TataPowerUtils.TYPE_RA1OO_QTY_ASSIGNEES);
				}
					...
					ruList = TataPowerUtils.getRUList(aSystemId, aRequestId, TataPowerUtils.TYPE_RA100_HEAD_OF_CONST_ASSIGNEES);
				}
				else if (curStatus.equals(TataPowerUtils.STATUS_FINANCE)){
					ruList = TataPowerUtils.getRUList(aSystemId, aRequestId, TataPowerUtils.TYPE_RA100_FINANCE_ASSIGNEES);
				}				
