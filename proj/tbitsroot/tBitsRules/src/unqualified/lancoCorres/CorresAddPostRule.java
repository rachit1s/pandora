...
public class CorresAddPostRule implements IPostRule {
			...
			Hashtable<Field, RequestEx> extendedFields, boolean isAddRequest) 
	{
		...
		{			
			...
			if( (null != ba) && (null != ba.getSystemPrefix()) &&  ba.getSystemPrefix().equalsIgnoreCase(KskConstants.CORR_SYSPREFIX)  )				
			{
				...
				String corrInit = (String) currentRequest.myMapFieldToObjects.get(KskConstants.CORR_CORRESPONDANCE_INITIATOR_FIELD_NAME) ;
				String type = (String) currentRequest.myMapFieldToObjects.get(KskConstants.CORR_TYPE_FIELD_NAME) ;				
...
//					int fcsysid = 
				...
				params.put(Field.USER, User.lookupByUserLogin(KskConstants.ROOT_USER).getUserLogin()+"") ;
