 ...
 *
 */
public class UPostHandler implements IEventHandler<UpdatePostEvent>{
	...
	public String getDescription() {
		return "Registered for UpdatePostEvent class";
	}
	 ...
	 */
	@Override
	public void handle(UpdatePostEvent event) throws EventFailureException {
