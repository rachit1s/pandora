...
public class ServerSnoop extends GenericServlet {
	public void service(ServletRequest req, ServletResponse res)
		...
		out.println("changed tempdir : " + context.getAttribute("javax.servlet.context.tempdir"));
		
		context.setAttribute("javax.servlet.context.tempdir.myown", "/tmp");
		out.println("changed myown tempdir : " + context.getAttribute("javax.servlet.context.tempdir.myown"));
