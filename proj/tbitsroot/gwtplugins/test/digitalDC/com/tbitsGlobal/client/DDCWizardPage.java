...
public class DDCWizardPage extends
		TransmittalAbstractWizardPage<FormPanel, HashMap<String, String>> {

	private DDCAttachmentFieldContainer fieldContainer;
	DDCWizard parentWizard;

	protected DDCWizardPage(UIContext wizardContext,
			DDCWizard holcimWizard) {
		super(wizardContext);
	...
	public boolean onLeave() {
		...
		if (DDCMultiUploader.repoFileId != -1) {
	...
	public void buildPage(WizardData data) {
		...
		fieldContainer = new DDCAttachmentFieldContainer(parentWizard);
