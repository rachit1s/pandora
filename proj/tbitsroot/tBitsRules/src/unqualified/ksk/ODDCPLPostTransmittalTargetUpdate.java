 ...
 *
 */
public class ODDCPLPostTransmittalTargetUpdate implements ITransmittalRule {
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if(KSKUtils.isDCPLDCR(dcrBA) && (currentBA.getSystemPrefix().equals("PHO") 
											|| currentBA.getSystemPrefix().equals("CEC")
											|| currentBA.getSystemPrefix().equals("IntDTR"))){
