...
import kskCorr.others.GenCorrNoHelper;
import kskCorr.others.KskConst;
import kskCorr.others.KskManager;
...
public class CorrNumberConstraint implements ICorrConstraintPlugin {
	...
	public void execute(Hashtable<String, Object> params) throws CorrException 
	{
		...
		{
			String appBas = PropertiesHandler.getProperty(KskConst.CorrBaList);
			if( null == appBas )
			{
				LOG.info("Property not found : " + KskConst.CorrBaList + " in tbits_properties.");
				return ;
			}
