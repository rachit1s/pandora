 ...
 *
 */
public class AdhocDCPLPostTransmittalDTRUpdate implements ITransmittalRule {
	...
	public String getName() {
		...
		return this.getClass().getSimpleName() + ": Updates DTR business area post-transmittal for DCPL initiated transmittal.";
	}
...
//		9.Priority: Set value of Decision to IPLE  in DCPL_DCR
		...
		if (IPLUtils.isAdhocTCEDCR(dcrBA) && (currentBA.getSystemPrefix().equals("DTR"))){	
