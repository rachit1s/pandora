 ...
 *
 */
public class ODSITEPostTransmittalDCRUpdate implements ITransmittalRule {
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if(dcrBA.getSystemPrefix().equals("ODSITE") && currentBA.getSystemPrefix().trim().equals("ODSITE")){
