 ...
 *
 */
public class AdhocIPLEPostTransmittalDTRUpdate implements ITransmittalRule {
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if ((businessAreaType == IPLUtils.DTR_BUSINESS_AREA) && IPLUtils.isAdhocIPLEDCR(dcrBA)){	
			...
			if (transmittalType.equals("TransmitToDCPL")){
				paramTable.put(Field.USER, "DC-IPLE, DC-DCPL");
