 ...
 *
 */
public class PostEvent implements IPostRequestCommitEvent{
	 ...
	 * @param isAddRequest
	 */
	public PostEvent(Connection con, BusinessArea ba, Request oldRequest,
			Request currentRequest, int source, User user, boolean isAddRequest, TBitsResourceManager trm) {
		super();
		this.con = con;
		this.ba = ba;
	...
	public String toString() {
		return "PostEvent [con=" + con + ", ba=" + ba + ", source=" + source + ", user=" + user + ", isAddRequest="
				+ isAddRequest + "]";
	}
	...
	/* (non-Javadoc)
	 * @see transbit.tbits.events.IPostRequestCommitEvent#getTBitsResourceManager()
	 */
	@Override
