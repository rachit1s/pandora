if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[stp_roleperm_getPermissionsBySystemIdAndRequestIdAndActionIdAndUserId]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[stp_roleperm_getPermissionsBySystemIdAndRequestIdAndActionIdAndUserId]
GO
