...
//	public static final String STAMP = "D:\\myphoto.png";
//	public static final String STAMP = "D:\\DTN Zipped File\\DTN Zipped File\\600MP_DTN\\FMG-EXT-600-7335\\63-1-600MP0053-02012-DR-IN-0021_A_20.png";
...
//			 OpenCVUtils.show(colorDest2, "Contours");
			...
			List<CvSeq> list = new ArrayList<CvSeq>();
...
//					rect.add(rectangle0);
			...
			drawAllContours(colorDest2, list, CvScalar.GREEN, 2);
	...
	public static boolean matching(List<CvRect> rects,CvRect rect0){
	...
	public static void main(String[] args) {
		ListRectangle desc = new ListRectangle();
		desc.extractShapes();
	}
	...
	public static void sharp() {
		...
		try {
			File f = new File("D:\\DTN Zipped File\\DTN Zipped File\\600MP_DTN\\FMG-EXT-600-7335\\63-1-600MP0053-02012-DR-IN-0021_A_20.png");
			...
			File file = new File("D:\\sharp.png");
			file.createNewFile();
