...
package eclipse.birt.report.data.oda.csv.ui.impl;

import java.util.Properties;

import eclipse.birt.report.data.oda.csv.impl.Query;
...
public class CustomDataSetWizardPage extends DataSetWizardPage
{
	...
	{
		super( pageName );
		System.out.println("CustomDataSetWizardPage:constructor: pageName "+ pageName);        
        setTitle( pageName );
	...
	private void initializeControl( )
	{
		...
		System.out.println("/nCustomDataSetWizard:initializeControl");
	...
	{
        System.out.println("CustomDataSetWizardPage:collectDataSetDesign:design"+ design);
		if( ! hasValidData() )
            return design;
        savePage( design );
        return design;
	...
	{
		System.out.println("CustomDataSetWizard:savePage()");
...
//******************************************************************************************************
//for time being removed are marked with //******
      ...
      //******       IConnection customConn = null;
        try
        {
             ...
             */
        	    IDriver customDriver = new eclipse.birt.report.data.oda.csv.impl.Driver();
        	...
        	System.out.println("CustomDataSetWizard:savePage():connProps"+ connProps);
//            Properties sysProps = System.getProperties();
//            sysProps.put("app.name", "tbits");
            //sysProps.put("tbits.home", connProps.get("tbitsHome"));
        	customConn.open( connProps ); // we can create an object of DQLSerarcher
...
//+++        	    IConnection customConn = null;
    ...
    private void updateDesign( DataSetDesign dataSetDesign,
        ...
        throws OdaException
    {
    	System.out.println("CustomDataSetWizard: updateDesign:queryText  "+queryText);
    	 	IQuery query = conn.newQuery( null ); 
//+++    	IQuery query = new Query();
        query.prepare( queryText ); // call for validation in our case can be skipped
...
//        System.out.println("query.executeQuery() "+resultSet); 
        ...
        try
        {
            ...
            updateResultSetDesign( md, dataSetDesign );
             System.out.println("CustomDataSetWizardPage:updateDesign:dataSetDesign "+ dataSetDesign);   
        }
        catch( OdaException e )
        {
	...
	private void updateResultSetDesign( IResultSetMetaData md,
        ...
        throws OdaException
	{
        //System.out.println("CustomDataSetWizardPage:updateResultSetDesign");
		ResultSetColumns columns = DesignSessionUtil.toResultSetColumnsDesign( md );
//		System.out.println("CustomDataSetWizardPage:updateResultSetDesign:columns"+columns);    
        ResultSetDefinition resultSetDefn = DesignFactory.eINSTANCE
                .createResultSetDefinition();
  //      System.out.println("CustomDataSetWizardPage:updateResultSetDesign:ResultSetDefinition"+resultSetDefn);
        // resultSetDefn.setName( value );  // result set name
        resultSetDefn.setResultSetColumns( columns );
    //    System.out.println("CustomDataSetWizardPage:updateResultSetDesign:setResultSetcolumns");

        // no exception in conversion; go ahead and assign to specified dataSetDesign
        dataSetDesign.setPrimaryResultSet( resultSetDefn );
//        System.out.println("CustomDataSetWizardPage:updateResultSetDesign:setPrimaryResultSet");
        dataSetDesign.getResultSets().setDerivedMetaData( true );
        System.out.println("CustomDataSetWizardPage:updateResultSetDesign:setMetaData(true)");
	}
