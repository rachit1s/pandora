 ...
 *
 */
public class AdhocIPLPPostTransmittalDTRUpdate implements ITransmittalRule {
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if ((businessAreaType == IPLUtils.DTR_BUSINESS_AREA) && IPLUtils.isAdhocIPLPDCR(dcrBA)){	
