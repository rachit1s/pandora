package impCorr.rule;

import impCorr.others.Constants;
import impCorr.others.GenCorrNoHelper;
...
public class CorrNumberConstraint implements ICorrConstraintPlugin {
	...
	public void execute(Hashtable<String, Object> params) throws CorrException 
	{
		...
		else
		{
			...
			String appBas = PropertiesHandler.getProperty(Constants.CorrBaList);
			if( null == appBas )
			{
				LOG.info("Property not found : " + Constants.CorrBaList + " in tbits_properties.");
				return ;
			}
