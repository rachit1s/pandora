...
public class Ex6ShapeDescriptors {
	...
	public static final String STAMP = "/home/rahul/files/new.png";
...
//			 drawAllContours(colorDest2, filteredContours, CvScalar.BLUE, 2);
			...
			for (int i = 0; i < filteredContours.size(); i++) {
				int update = 0;
				CvRect rectangle0 = cvBoundingRect((CvArr) contours.get(i),
						update);
...
//			OpenCVUtils.show(colorDest2, "Contours");
	...
	public static void main(String[] args) {
		Ex6ShapeDescriptors desc = new Ex6ShapeDescriptors();
		desc.extractShapes();
	}
	...
	public static void sharp() {
		...
		try {
			File f = new File("/home/rahul/files/newStamp.png");
			...
			File file = new File("/home/rahul/files/new.png");
			file.createNewFile();
