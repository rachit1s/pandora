 ...
 *
 */
public class AdhocDCPLPostTransmittalIDTRUpdate implements ITransmittalRule {
	...
	public String getName() {
		...
		return this.getClass().getSimpleName() + ": Updates IDTR business area post-transmittal for DCPL initiated transmittal.";
	}
...
//		9.Priority: Set value of Decision to IPLE  in DCPL_DCR
		...
		if (IPLUtils.isAdhocTCEDCR(dcrBA) && (currentBA.getSystemPrefix().equals("IDTR"))){	
