...
public class ProjectManagementAbsDatesTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		TaskDetails td = new TaskDetails(null, null, sc.getTime(), ed.getTime(), 1, 1, null,1);
		tasks.add(td);
		...
		tasks.add(new TaskDetails(null, null, sc.getTime(), ed.getTime(), 1, 2, null, 1));
	...
	public void test1SS0_1()
	{
		...
		TaskDetails td = pm.getSchedule(c.getTime(), c.getTime(), 1, preds, null, false);
		
		c.setTime(td.actualStartDate);
		assertEquals(14, c.get(Calendar.DATE));
		assertEquals(4, c.get(Calendar.MONTH));
		
		c.setTime(td.actualEndDate);
		assertEquals(14, c.get(Calendar.DATE));
		assertEquals(4, c.get(Calendar.MONTH));
	}
	...
	public void test1SS1_2()
	{
		...
		TaskDetails td = pm.getSchedule(c.getTime(), c.getTime(), 2, preds, null, false);
	...
	public void testInit()
	{
		...
		ArrayList<Predecessor> preds = new ArrayList<Predecessor>();
		//preds.add(new Predecessor(1, 1,DepType.FS));
		TaskDetails td = pm.getSchedule(null, null, null, preds, c.getTime(), false);
	...
	public void testInit1()
	{
		...
		ArrayList<Predecessor> preds = new ArrayList<Predecessor>();
		//preds.add(new Predecessor(1, 1,DepType.FS));
		TaskDetails td = pm.getSchedule(null, null, null, preds, null, false);
