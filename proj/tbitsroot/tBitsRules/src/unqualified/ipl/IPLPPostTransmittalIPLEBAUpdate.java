 ...
 *
 */
public class IPLPPostTransmittalIPLEBAUpdate implements ITransmittalRule {
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if (IPLUtils.isIPLPDCR(dcrBA) && transmittalType.equals("TransmitToIPLE")
				&& currentBA.getSystemPrefix().trim().equals("IPLE")){	
