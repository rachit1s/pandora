...
public class DDCAttachmentFieldContainer extends FieldSet {
	...
	public DDCAttachmentFieldContainer(DDCWizard parentWizard) {
		super();
...
//		Log.info("Inside Grid");
			...
			addUploader = new DDCMultiUploader("", 0, 0, new TbitsAddUploadStatus((IUploadProgress) uploadProgressGrid), TbitsMultiUploader.ADD_FILES,parentWizard);
			uploaderContainer.add((DDCMultiUploader)addUploader, new ColumnData(75));
