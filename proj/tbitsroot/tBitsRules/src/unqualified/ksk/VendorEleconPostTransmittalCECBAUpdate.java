 ...
 *
 */
public class VendorEleconPostTransmittalCECBAUpdate implements ITransmittalRule {

	/* (non-Javadoc)
	 * @see ksk.ITransmittalRule#getName()
	 */
	public String getName() {
		return this.getClass().getSimpleName() + ": Updates the CEC business area post Elecon transmittal.";
	}
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if (KSKUtils.isEleconDCR(dcrBA) && currentBA.getSystemPrefix().equals(KSKUtils.CEC_SYS_PREFIX)){
			String dtnNumber = "";
