 ...
 *
 */
public class DueDateAndType60PercentStatus implements IRule {
	...
	public RuleResult execute(Connection connection, BusinessArea ba,
		...
		if (isApplicable && (requestType.getName().equals(TataPowerUtils.TYPE_SIXTY_PERCENT)) 
	...
	public static void main(String[] args) throws DatabaseException {
		...
		try {
			...
			irule.execute(conn, ba, null, req, TBitsConstants.SOURCE_CMDLINE, root, 
					req.getExtendedFields(), false, null);
