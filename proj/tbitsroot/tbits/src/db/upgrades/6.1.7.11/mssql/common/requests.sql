...
GO
ALTER TABLE dbo.Tmp_requests ADD CONSTRAINT
	DF__requests__office__166F3B3A DEFAULT ((0)) FOR office_id
GO
IF EXISTS(SELECT * FROM dbo.requests)
	 EXEC('INSERT INTO dbo.Tmp_requests (sys_id, request_id, category_id, status_id, severity_id, request_type_id, subject, description, is_private, parent_request_id, user_id, max_action_id, due_datetime, logged_datetime, lastupdated_datetime, header_description, attachments, summary, memo, append_interface, notify, notify_loggers, replied_to_action, office_id, max_request_file_id)
		SELECT sys_id, request_id, category_id, status_id, severity_id, request_type_id, subject, description, is_private, parent_request_id, user_id, max_action_id, due_datetime, logged_datetime, lastupdated_datetime, header_description, attachments, summary, memo, append_interface, notify, notify_loggers, replied_to_action, office_id, max_request_file_id FROM dbo.requests WITH (HOLDLOCK TABLOCKX)')
GO
