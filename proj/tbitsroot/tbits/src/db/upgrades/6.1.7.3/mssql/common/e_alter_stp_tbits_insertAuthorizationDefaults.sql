if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[stp_tbits_insertAuthorizationDefaults]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[stp_tbits_insertAuthorizationDefaults] 
GO
