...
public class CorresConstants 
{
	...
	public static final String CORR_ORIG_AEC = "AEC";
...
//	public static final String KNPL_CC_USER = "knplteam";
	...
	public static final String VALID_ION_AGENCY = "valid_ion_agencies";
	
///////////////////////// CONSTANTS SPECIFIC TO NAGAI_CORR /////////////////	
	
	public static final String NAGAI_CORR_SYSPREFIX = "NAGAI_CORR" ;
	public static final String CORR_ORIG_ACBL = "ACBL" ;
	public static final String CORR_ORIG_TPSC = "TPSC";
	public static final String CORR_ORIG_NPPL = "NPPL"; // same as KNPL
	
	public static final String NAGAI_CONTRACT_REF = "ContractReference" ;
	public static final String NAGAI_UNIT_CODE = "Unit";
	public static final String NAGAI_CORR_CATEGORY = Field.CATEGORY;
	public static final String NAGAI_DEPARTMENT_CODE = "Department";
	public static final String NAGAI_PACKAGE_TYPE = "PackageType";
	public static final String NAGAI_PACKAGE = "Package";
}
