 ...
 *
 */
public class DueDateAndType40PercentStatus implements IRule {
		...
		if (isApplicable && (requestType.getName().equals(TataPowerUtils.TYPE_FORTY_PERCENT))
			...
			try {	
				...
				if (dccDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.FOURTY_PERCENT_DCC_OFFSET);				
				...
				if (udsiDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.FOURTY_PERCENT_SI_OFFSET);
				...
				if(ghDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.FOURTY_PERCENT_QS_OFFSET);
				...
				if(qsDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.FOURTY_PERCENT_GH_OFFSET);
				...
				if(hocDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.FOURTY_PERCENT_HOC_OFFSET);
				...
				if(financeDateField != null){
					dateOffset = TataPowerUtils.getPropertyIntValue(TataPowerUtils.FOURTY_PERCENT_FINANCE_OFFSET);
