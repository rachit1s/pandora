 ...
 *
 */
public class RWISSITEPostTransmittalDCRUpdate implements ITransmittalRule {

	public String getName() {
		return this.getClass().getSimpleName() + ": Post trasnmittal DCR update in ERC initiated transmittal process.";
	}
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if(KSKUtils.isRWISSITE(dcrBA) && currentBA.getSystemPrefix().trim().equals("RWIS_SITE")){
