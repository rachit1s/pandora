 ...
 *
 */
public class AdhocDCPLPostTransmittalIPLEBAUpdate implements ITransmittalRule {

	/* (non-Javadoc)
	 * @see ksk.ITransmittalRule#getName()
	 */
	public String getName() {
		return this.getClass().getSimpleName() + ": Updates the IPLE business area post DCPL transmittal.";
	}
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if (IPLUtils.isAdhocTCEDCR(dcrBA) && 
				transmittalType.equals("TransmitToIPLE") && 
				currentBA.getSystemPrefix().equals(IPLUtils.ADHOC_IPLE)){	
			...
			paramTable.put (Field.DESCRIPTION,"Document returned to IPLE with decision from DCPL via letter of Transmital number #" 
