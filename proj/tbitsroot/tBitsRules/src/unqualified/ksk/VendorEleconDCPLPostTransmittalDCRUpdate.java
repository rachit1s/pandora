 ...
 *
 */
public class VendorEleconDCPLPostTransmittalDCRUpdate implements ITransmittalRule {
	...
	public void process(Connection connection, int transmittalId,  Request transmittalRequest,
		...
		if(KSKUtils.isDCPLDCR(dcrBA) && currentBA.getSystemPrefix().trim().equals(KSKUtils.DCPL_SYS_PREFIX)){
			...
			if (transmittalType.equals(KSKUtils.TRANSMIT_TO_ELECON)){
				...
				paramTable.put(Field.DESCRIPTION, "Document submitted with comments via letter of Transmittal number #"
				...
				//2.	Description is updated as “The RFC file has been validated DCPL & has been found
				...
				//2.	Description is updated as the AsBuilt file has been validated by WPCLDCPL & has been 
