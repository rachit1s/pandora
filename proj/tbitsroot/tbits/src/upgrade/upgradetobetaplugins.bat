@rem upgradetobetaplugins.bat [customer_folder] [plugin_to_upgrade]
@echo off
set USER=transbit
...
:Error
echo "Usage: upgradetobetaplugins.bat <server-plugin-folder> <your-plugin-folder>"
echo Example upgradetobetaplugins.bat ksk kskCorres
