...
CREATE PROCEDURE [dbo].[stp_request_delete_requests_in_ba] 
(
...
BEGIN
  ...
  BEGIN TRANSACTION            
	...
	delete from related_requests where primary_sys_prefix = @sys_prefix and primary_request_id = @request_id

        delete from related_requests where related_sys_prefix = @sys_prefix and related_request_id = @request_id
