 ...
 *
 */
public class SEPCOPostTransmittalDCPLBAUpdate implements ITransmittalRule {
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if (KSKUtils.isSEPCODCR(dcrBA) && currentBA.getSystemPrefix().equals("DCPL")){
			...
			paramTable.put(Field.USER, "DC-WPCL");
			...
			if (transmittalType.equals(KSKUtils.TRANSMIT_TO_WPCL)){
				...
				paramTable.put (Field.DESCRIPTION,"Document submitted to KMPCL for review via letter of Transmital number #" 
