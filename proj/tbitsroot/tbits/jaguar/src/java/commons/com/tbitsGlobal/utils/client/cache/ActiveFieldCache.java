 ...
 * Cache for fields
 */
public class ActiveFieldCache extends FieldCache {
	
	public ActiveFieldCache() {
		super();
	...
	protected void getFromServer() {
		GlobalConstants.utilService.getActiveFields(ClientUtils.getSysPrefix() ,new AsyncCallback<List<BAField>>() {
