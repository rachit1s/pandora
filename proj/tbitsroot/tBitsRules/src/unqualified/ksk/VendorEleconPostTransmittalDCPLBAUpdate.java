 ...
 *
 */
public class VendorEleconPostTransmittalDCPLBAUpdate implements ITransmittalRule {
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if (KSKUtils.isEleconDCR(dcrBA) && currentBA.getSystemPrefix().equals(KSKUtils.DCPL_SYS_PREFIX)){
