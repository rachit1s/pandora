 ...
 *
 */
public class AddPreHandler implements IEventHandler<IAddPreEvent>{
	...
	public String getDescription() {
		return "Registered for IAddPreEvent";
	}
	 ...
	 */
	@Override
	public void handle(IAddPreEvent event) throws EventFailureException {
