 ...
 *
 */
public class AdhocSEPCOPostTransmittalDTRUpdate implements ITransmittalRule {
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if ((businessAreaType == IPLUtils.DTR_BUSINESS_AREA) && IPLUtils.isAdhocBHELDCR(dcrBA)){	
			/*
			...
			*/
			...
			if (transmittalType.equals("TransmitToIPLE")){
				...
				//1.	Logger : SEPCO-mailing List
				paramTable.put(Field.USER, "SEPCO, SITE");
