/****** Object:  StoredProcedure [dbo].[stp_request_delete_requests_in_ba]    Script Date: 09/09/2011 13:40:43 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
  ...
  BEGIN TRANSACTION            
	...
	delete from requestfilemaxid where sys_id = @systemId and request_id = @request_id
  COMMIT TRANSACTION
