...
public class SubRequestSubject implements IPreRenderer {	
	...
	public void process(HttpServletRequest request,
		...
		try{			
			...
			if (keys[1].equals("add-subrequest") && isRuleApplicable){
				...
				int count = PyramidUtils.getSubRequestCountBySysIdReqId(ba.getSystemId(), parentRequest.getRequestId());
	...
	public static void main (String[] args){
		try {
			System.out.println("Count: " + PyramidUtils.getSubRequestCountBySysIdReqId(6, 42));
