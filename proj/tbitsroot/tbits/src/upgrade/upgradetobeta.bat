...
set src=upgrades.mytbits.com::upgrades/tbits/beta
set dest=..

set opts=-avz --progress --delete --modify-window=1 --chmod=ugo=rwX
...
echo rsync.exe %opts% --exclude=plugins %src%/%dir% %dest%/
