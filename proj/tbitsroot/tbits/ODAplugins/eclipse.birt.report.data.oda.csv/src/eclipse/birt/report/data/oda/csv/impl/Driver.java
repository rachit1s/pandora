/*
 *************************************************************************
 * Copyright (c) 2007 <<Transbit Technology>>
 *  
 *************************************************************************
 */
...
{
    static String ODA_DATA_SOURCE_ID = "eclipse.birt.report.data.oda.csv";  //$NON-NLS-1$
	...
	{
		System.out.println("In Driver getConnection");
		System.out.println("In Driver getConnection dataSourceType: "+dataSourceType);
        ...
        throws OdaException
    {
        ...
        System.out.println("Query:getNativeDataTypeName() typeMapping "+ typeMapping );
        if( typeMapping != null )
