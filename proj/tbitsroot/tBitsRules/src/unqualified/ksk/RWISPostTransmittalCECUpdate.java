 ...
 *
 */
public class RWISPostTransmittalCECUpdate implements ITransmittalRule {
	...
	public void process(Connection connection, int transmittalId, Request transmittalRequest,
		...
		if (KSKUtils.isRWISPHODCR(dcrBA) && currentBA.getSystemPrefix().trim().equals(KSKUtils.RWIS_CEC)){
			...
			if (transmittalType.equals(KSKUtils.TRANSMIT_TO_RWIS_CEC)){
				...
				paramTable.put (Field.DESCRIPTION,"Comments received from RWIS-PHO via DTN #" 
