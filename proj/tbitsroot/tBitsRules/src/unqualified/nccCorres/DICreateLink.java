...
public class DICreateLink implements IActionDetailsHeaderSlotFiller 
{
			...
			User user) 
	{
		...
		String path = "proxy/" + IDPrefillProxyServlet.servletName + "?"+CorresConstants.CORR_SYS_ID+"=" + sysId + "&" + CorresConstants.CORR_REQUEST_ID + "=" + requestId  ;
		String relativePath = WebUtil.getNearestPath(httpRequest, path) ;
		String linkHtml = "<a href='" + relativePath + "' target='_blank'>" + CorresConstants.CORR_LINK_NAME + "</a>" ; 
