 ...
 *
 */
public class GetPropCSI_DocSize implements DMSGetPropAction<ActionContext> {
	
	/** log4j logger for the GetPropCSI_DocDateLastModified class*/
	private static final Logger m_logger = LogManager.getLogger(GetPropCSI_DocSize.class);
...
//		DMSProperty  attrs = getAttrs(context.getBackendAPI(),context.getBackendSession(session, query),query, docID);
		DMSProperty retProp = new DMSProperty(Property.CSI_DocSize, 1024/*attrs.getFirstChildValue("DocSize")*/);
		return retProp;
	}
}
